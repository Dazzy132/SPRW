...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('groups', '0007_alter_groups_group_slug'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complaint', models.CharField(choices=[('drugs', 'Публикация содержит пропоганду наркотиков'), ('child pornography', 'Публикация содержит детскую порнография')], max_length=200, verbose_name='Жалоба')),
                ('complaint_status', models.CharField(choices=[('in_process', 'Жалоба на рассмотрении'), ('done', 'Жалоба рассмотрена'), ('not substantiated', 'Жалоба не обоснована')], default='in_process', max_length=200, verbose_name='Статус жалобы')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='groups.groups', verbose_name='Группа на которую поступила жалоба')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='пользователь оставивший жалобу')),
            ],
            options={
